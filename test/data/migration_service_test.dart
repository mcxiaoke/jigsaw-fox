...
void main() {
  ...
  group('MigrationService v3.3.1 Tests', () {
    test('16-piece (4x4) merges into 25-piece (5x5) taking best values and deletes 4x4', () async {
      ...
      final initial = LevelProgress(
        canonicalId: cid,
        records: const {
          '4x4': DifficultyRecord(bestStars: 3, bestTimeSeconds: 40, isCompleted: true, playCount: 2, minHintsUsed: 0),
          '5x5': DifficultyRecord(bestStars: 2, bestTimeSeconds: 60, isCompleted: true, playCount: 1, minHintsUsed: 1),
        },
      );
    ...
    test('Ghost difficulty cleanup keeps completed stars and deletes uncompleted snapshots', () async {
      final prefs = await SharedPreferences.getInstance();
      const cid = 'main:008';
      ...
      final initial = LevelProgress(
        canonicalId: cid,
        records: const {
          '6x8': DifficultyRecord(bestStars: 3, bestTimeSeconds: 120, isCompleted: true, playCount: 1),
          '9x12': DifficultyRecord(bestStars: 0, bestTimeSeconds: 0, isCompleted: false, playCount: 1),
        },
      );
      await ProgressStore.instance.save(initial);
