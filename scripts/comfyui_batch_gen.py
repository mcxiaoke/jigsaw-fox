    ...
    * Lighting / viewpoint / detail / atmosphere are drawn from a per-job RNG seeded
    ...
    for tag in lib["tags"]:
        ...
        for i in range(count):
            ...
            parts.append(rng.choice(lib["modifiers"]["detail"]))
            if "atmosphere" in lib["modifiers"]:
...
def parse_args(argv=None):
    ...
    p.add_argument("--library", default=str(Path(__file__).with_name("jigsaw_prompt_library.json")),
